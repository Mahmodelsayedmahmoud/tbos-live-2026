  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 border border-blue-200 transition-all duration-200 group"
      >
        <MapPin size={16} className="text-blue-600 group-hover:scale-110 transition-transform" />
        <div className="text-right">
          <div className="text-xs text-gray-500">{lang === 'ar' ? 'الفرع الحالي' : 'Current Branch'}</div>
